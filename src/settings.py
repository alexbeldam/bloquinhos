...
class UIThemeConfig:
    ...
    SETTINGS_SCREEN_BG: Color = (20, 24, 36)
    SETTINGS_SIDEBAR_BG: Color = (24, 28, 42)
    SETTINGS_DIVIDER: Color = (50, 56, 78)
    SETTINGS_TAB_BG: Color = (29, 34, 48)
    SETTINGS_TAB_BG_HOVER: Color = (40, 45, 64)
    SETTINGS_TAB_BG_ACTIVE: Color = (48, 40, 66)
    SETTINGS_RESET_BG: Color = (64, 44, 48)
    SETTINGS_RESET_BORDER: Color = (96, 68, 74)
    SETTINGS_RESET_BG_HOVER: Color = (74, 48, 52)
    SETTINGS_RESET_BORDER_HOVER: Color = (112, 74, 80)
    SETTINGS_RESET_BG_ARMED: Color = (94, 52, 52)
    SETTINGS_RESET_BORDER_ARMED: Color = (130, 74, 74)
    SETTINGS_TOOLTIP_BG: Color = (35, 39, 50)
    SETTINGS_CONTENT_BG: Color = (33, 39, 58)
    SETTINGS_SECTION_RESET_BG: Color = (50, 50, 64)
    SETTINGS_SECTION_RESET_BG_HOVER: Color = (58, 58, 72)
    SETTINGS_SECTION_RESET_BORDER: Color = (76, 76, 92)
    SETTINGS_SECTION_RESET_BORDER_HOVER: Color = (90, 90, 108)
    SETTINGS_DROPDOWN_BG: Color = (43, 50, 70)
    SETTINGS_DROPDOWN_BORDER: Color = (60, 66, 85)
    SETTINGS_DROPDOWN_OPTION_BG_SELECTED: Color = (60, 66, 85)
    SETTINGS_DROPDOWN_OPTION_BG_HOVER: Color = (70, 76, 95)
    SETTINGS_DROPDOWN_OPTION_BG: Color = (50, 56, 75)
    SETTINGS_SLIDER_BG: Color = (50, 55, 70)
    SETTINGS_SLIDER_MUTED: Color = (100, 100, 100)
    SETTINGS_ROW_BG: Color = (34, 40, 57)
    SETTINGS_ROW_BG_HOVER: Color = (43, 50, 70)
    SETTINGS_ROW_BG_SELECTED: Color = (50, 56, 75)
